...
class Deck:
	...
	def shuffle_deck(self):
		"""
		Reshuffle the deck to a fully-shuffled 52-card deck.
		"""
	...
	def cards_remaining(self):
		"""
		Return a list of cards still in the deck
		"""
		return self.cards
	
	def revealed_cards(self):
		"""
		Return a list of cards that have been revealed from the deck 
		"""
	...
	def cards_remaining_by_name(self, name):
		"""
		Returns the number of cards left of a certain name
		"""
		n = 0
